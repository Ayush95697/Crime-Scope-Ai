...
STATE_DISTRICTS = {
    ...
    'MIRZAPUR', 'MORADABAD', 'MUZAFFARNAGAR', 'PILIBHIT', 'PRATAPGARH', 'RAE BARELI', 'RAMPUR',
    'SAHARANPUR', 'SAMBHAL', 'SANT KABIR NAGAR', 'SANT RAVIDAS NAGAR', 'SHAHJAHANPUR', 'SHAMLI',
...
def load_models():
    try:
        ...
        encoder_path = "artifacts/crime_encoder.joblib"
